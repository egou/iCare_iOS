...
+(NSArray*)allProblemsInfo{
    ...
    if(!_allValues){
        _allValues=@[[self objWithId:1 name:@"临界高血压" category:1 index:2],
                     [self objWithId:2 name:@"血压正常" category:1 index:0],
                     [self objWithId:3 name:@"低血压" category:1 index:1],
                     ...
                     [self objWithId:21 name:@"房性早搏" category:6 index:0],
                     [self objWithId:22 name:@"房性早搏二联律" category:6 index:1],
                     [self objWithId:23 name:@"房性早搏三联律" category:6 index:2],
                     [self objWithId:24 name:@"短阵房速" category:6 index:3],
                     [self objWithId:25 name:@"房颤" category:6 index:4],
                     [self objWithId:26 name:@"房扑" category:6 index:5],
                     [self objWithId:27 name:@"室上速" category:6 index:6],
                     
                     [self objWithId:28 name:@"室性早搏" category:7 index:0],
                     [self objWithId:29 name:@"室性二联律" category:7 index:1],
                     [self objWithId:30 name:@"室性三联律" category:7 index:2],
                     [self objWithId:31 name:@"短阵室速" category:7 index:3],
                     [self objWithId:32 name:@"室颤" category:7 index:4],
                     [self objWithId:33 name:@"室扑" category:7 index:5],
                     
                     [self objWithId:34 name:@"Ⅰ度" category:8 index:0],
                     [self objWithId:35 name:@"Ⅱ度Ⅰ型" category:8 index:1],
                     [self objWithId:36 name:@"Ⅱ度Ⅱ型" category:8 index:2],
                     [self objWithId:37 name:@"Ⅲ度" category:8 index:3],
                     
                     [self objWithId:38 name:@"Ⅱ度Ⅰ型" category:9 index:0],
                     [self objWithId:39 name:@"Ⅱ度Ⅱ型" category:9 index:1],
                     ];
    }
    return _allValues;
}
